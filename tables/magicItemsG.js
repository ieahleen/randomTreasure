...
export function magicItemsG() {
  ...
  switch (n) {
    ...
    case 31:
      return `Armor of resistance (chain mail), ${randomItemFromArray(
        damageTypes
      )}`;
    case 32:
      return 'Armor, +1 (chain shirt)';
    case 33:
      return `Armor of resistance (chain shirt), ${randomItemFromArray(
        damageTypes
      )}`;
    case 34:
    ...
    case 44:
      return `Giant slayer, ${randomItemFromArray([
        ...swords,
        'battleaxe',
        'handaxe',
      ])}`;
    ...
    case 57:
      return `Armor of resistance (leather), ${randomItemFromArray(
        damageTypes
      )}`;
    case 58:
